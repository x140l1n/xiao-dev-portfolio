...
<template>
    <main class="container-fluid bg-dark vh-100 d-flex p-0">
        <div ref="monitor" class="card monitor mx-auto bg-light">
            ...
            <div class="card-footer border-0 bg-transparent d-flex flex-row-reverse justify-content-between">
                <button
                    tabindex="3"
                    title="Botón on off"
                    alt="Botón on off"
                    :class="`rounded-circle mt-2 btn-on-off d-flex ${isMonitorOn ? 'btn-on' : 'btn-off'}`"
