<template>
  <div ref="content" class="p-4">
    <div ref="contentWrapper" class="row row-cols-2 g-4">
      <div class="col">
      ...
      <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" class="col">
        <div class="card mx-auto shadow">
          <div class="card-body d-flex">
            <div class="logo m-auto">
              <img
  ...
  methods: {
    ...
    onResize() {
      if (this.$el.clientWidth < 576) {
        this.$refs.contentWrapper.querySelectorAll('.card-body').forEach((element) => {
      ...
      if (this.$el.clientWidth < 1024) {
        this.$refs.contentWrapper.classList.remove('row-cols-2');
        this.$refs.contentWrapper.classList.add('row-cols-1');
      } else {
        this.$refs.contentWrapper.classList.remove('row-cols-1');
        this.$refs.contentWrapper.classList.add('row-cols-2');
      }
    },
    openBrowser(url) {
      this.$urlToOpen = url;
