                ...
                <div class="card-body">
                    <div ref="contentFront" class="d-flex h-100 p-4">
                        ...
                        <div ref="descriptionFront" class="flex-grow-1 description mx-4">
                            ...
                            <p>
                                ¡Hola! Me llamo Xiaolin Jin Lin y tengo {{ years }} años. Desde pequeño siempre me ha
                                atraído mucho el mundo de la tecnología. A los 19 años decidí a adentrarme en el mundo
                                de la informática y escogí la rama de programación.
                            </p>
                            <br />
                            <p>
                                Estudie el ciclo de DAM (Desarrollo Aplicaciones Multiplataforma) y luego el ciclo de
                                DAW (Desarrollo Aplicaciones Web) en el
                                <a href="https://politecnics.barcelona/" target="_blank"
                                    >Centro de Estudios Politécnicos</a
                                >. Hasta ahora he aprendido mucho, y cada vez me gusta más este mundo y tengo muchas
                                ganas de seguir aprendiendo.
                            </p>
                            <br />
                            <p>
                                A parte de programar, también hago danza y gracias a ello he podido adquirir disciplina
                                y constancia para poder mejorar tanto el ámbito personal como el ámbito profesional.
                            </p>
                            <br />
                            <p>
                                Me gusta trabajar en equipo, tengo iniciativa y ofrezco ideas y soluciones efectivas
                                para el proyecto. A la vez me gusta ayudar, compartir experiencias y conocimientos con
                                otras personas.
                            </p>
                            <br />
